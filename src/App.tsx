    ...
    return (
        <HubsContext.Provider value={hubs}>
            <Layout style={{ minHeight: "100vh" }}>
                ...
                <Layout>
                    <Header style={{ background: "#fff", padding: "0px 10px"}}><h1>Brick Remote</h1></Header>
                                ...
                                (
                                    ...
                                    <div>
                                        ...
                                        <p>The hub will then appear on the left side listing the ports A to D and the two tilt indicators for the
                                            X any Y axis. </p>
                                        <p><img style={{maxWidth: "800px"}} alt="brick-remote-pair" src="https://user-images.githubusercontent.com/783861/69191588-160e0580-0b23-11ea-993d-069fa5e7e45d.png" width="90%"/></p>
                                        ...
                                        <p><img style={{maxWidth: "500px"}} alt="brick-remote-keyboard-shortcuts" src="https://user-images.githubusercontent.com/783861/69191586-15756f00-0b23-11ea-8a0f-3b0c28b4cc84.png" width="50%" height="50%" /></p>
                                    </div>
                                )
                        }
                    </Content>
